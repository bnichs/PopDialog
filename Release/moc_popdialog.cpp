/****************************************************************************
** Meta object code from reading C++ file 'popdialog.h'
**
...
#error "The header file 'popdialog.h' doesn't include <QObject>."
...
void *MyDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "LayoutTree"))
        return static_cast< LayoutTree*>(const_cast< MyDialog*>(this));
